...
type FullNode interface {
	...
	StateGetParentDeals(ctx context.Context, blockCid cid.Cid) ([]*api.StateGetParentDealsResp, error)
	StateBlockMessages(ctx context.Context, blockCid cid.Cid) (*api.StateBlockMessagesRes, error)
	...
	StateMinerDeadlinesByMiner(context.Context, address.Address, types.TipSetKey) ([]*api.StateMinerDeadlinesByMinerInfo, error)

	StateGetActorsInfo(ctx context.Context, tsk types.TipSetKey) (*api.ActorStates, error)
	...
	StateReplayList(ctx context.Context, tps *types.TipSet) ([]*api.InvocResult, error)

	StateReplayLists(ctx context.Context,  height int64) ([]*api.InvocResult, error)

	StateComputeBaseFee(ctx context.Context, blockCid cid.Cid) (abi.TokenAmount, error)



	StateCallExt(context.Context,  *types.Message, types.ChainMsg, types.TipSetKey) (*api.InvocResult, error)

	StateReplayEx(context.Context, types.TipSetKey) ([]*api.InvocResults, error)


	StateGetMessageByHeightInterval(context.Context, int64 ) ([]*api.NMessage, error)

	StateGetBlockByHeightInterval(context.Context, int64 ) ([]*types.BlockHeaders, error)

	StateGetBlockByHeightWhere(ctx context.Context, params api.StateGetBlockByHeightIntervalParams ) ([]*types.BlockHeaders, error)



	StateGetMessageDealsByHeightInterval(context.Context, int64 ) ([]*api.StateGetParentDealsResp, error)

	StateGetMessageByHeightIntervalEx(ctx context.Context, params api.StateGetMessageByHeightIntervalParams) ([]*api.SMessage, error)



	StateGetBlockByHeight(context.Context, int64,int64 ) ([]*api.Blocks, error)
	...
	StateMessageByHeight(context.Context, abi.ChainEpoch) ([]*api.InvocResultExt, error)

	ClientIpfsAddGo(ctx context.Context, params api.ClientIpfsAddGoParams) (api.ClientIpfsAddGoParams, error)

	StateComputeBaseFeeTest(ctx context.Context) (abi.TokenAmount, error)

	StateReplayNoTs(context.Context, cid.Cid) (*api.InvocResult, error) //perm:read


	StateMarketStorageDealNoTs(context.Context, abi.DealID) (*api.MarketDeal, error) //perm:readc

	StateSectorGetInfoQa(context.Context, address.Address, abi.SectorNumber, types.TipSetKey) (*api.StateSectorGetInfoQaResp, error) //perm:read
