...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		StateGetActorsInfo func(ctx context.Context, key types.TipSetKey) (*api.ActorStates, error) `perm:"read"`
		...
		StateBlockMessages func(ctx context.Context, b cid.Cid) (*api.StateBlockMessagesRes, error) `perm:"read"`
		StateGetParentDeals func(ctx context.Context, b cid.Cid) ([]*api.StateGetParentDealsResp, error) `perm:"read"`
		StateReplayList func(ctx context.Context, tsp *types.TipSet) ([]*api.InvocResult, error) `perm:"read"`
		StateReplayLists func(ctx context.Context, height int64) ([]*api.InvocResult, error) `perm:"read"`
		...
		StateMinerDeadlinesByMiner func(ctx context.Context, m address.Address, tsk types.TipSetKey) ([]*api.StateMinerDeadlinesByMinerInfo, error) `perm:"read"`
		WalletBalanceByTs func(ctx context.Context, a address.Address, tsk types.TipSetKey) (types.BigInt, error) `perm:"read"`
		StateCallExt func(ctx context.Context, msg *types.Message, priorMsgs types.ChainMsg,tsk types.TipSetKey) (*api.InvocResult, error) `perm:"read"`
		StateReplayTest func(ctx context.Context, tsk types.TipSetKey, cids []cid.Cid) ([]*api.InvocResult, error) `perm:"read"`
		StateReplayEx func(ctx context.Context, tsk types.TipSetKey) ([]*api.InvocResults, error) `perm:"read"`
		StateComputeBaseFee func(ctx context.Context, b cid.Cid) (abi.TokenAmount, error) `perm:"read"`
		StateGetMessageByHeightInterval func(ctx context.Context, start int64) ([]*api.NMessage, error) `perm:"read"`
		StateGetBlockByHeightInterval func(ctx context.Context, start int64) ([]*types.BlockHeaders, error) `perm:"read"`
		StateGetBlockByHeightWhere func(ctx context.Context, params api.StateGetBlockByHeightIntervalParams) ([]*types.BlockHeaders, error) `perm:"read"`

		StateGetBlockByHeight func(ctx context.Context, start int64, end int64) ([]*api.Blocks, error) `perm:"read"`
		...
		StateMessageByHeight func(ctx context.Context,  epoch abi.ChainEpoch) ([]*api.InvocResultExt, error) `perm:"read"`
		ClientIpfsAddGo func(ctx context.Context,clientIpfsAddParams  api.ClientIpfsAddGoParams) (api.ClientIpfsAddGoParams, error) `perm:"read"`
		StateGetMessageByHeightIntervalEx func(ctx context.Context, params api.StateGetMessageByHeightIntervalParams) ([]*api.SMessage, error) `perm:"read"`
		StateComputeBaseFeeTest func(ctx context.Context) (abi.TokenAmount, error) `perm:"read"`
		StateReplayNoTs func(p0 context.Context, p2 cid.Cid) (*api.InvocResult, error) `perm:"read"`
		StateMarketStorageDealNoTs func(p0 context.Context, p1 abi.DealID) (*api.MarketDeal, error) `perm:"read"`
		StateGetMessageDealsByHeightInterval func(context.Context, int64) ([]*api.StateGetParentDealsResp, error) `perm:"read"`
		StateSectorGetInfoQa func(context.Context, address.Address, abi.SectorNumber, types.TipSetKey) (*api.StateSectorGetInfoQaResp, error) `perm:"read"`
