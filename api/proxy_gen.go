...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		StateGetActorsInfo func(ctx context.Context, key types.TipSetKey) (*ActorStates, error) `perm:"read"`
		StateGetRewardLastPerEpochReward func(ctx context.Context, key types.TipSetKey) (abi.TokenAmount, error) `perm:"read"`
		StatePreCommittedSectors func(ctx context.Context, addr address.Address, tsk types.TipSetKey) ([]uint64, error) `perm:"read"`
		StateMinerSectorNumbers func(ctx context.Context, addr address.Address, tsk types.TipSetKey) (num []uint64, err error) `perm:"read"`
		StateBlockMessages func(ctx context.Context, b cid.Cid) (*StateBlockMessagesRes, error) `perm:"read"`
		StateGetParentDeals func(ctx context.Context, b cid.Cid) ([]*StateGetParentDealsResp, error) `perm:"read"`
		StateReplayList func(ctx context.Context, tsp *types.TipSet) ([]*InvocResult, error) `perm:"read"`
		StateReplayLists func(ctx context.Context, height int64) ([]*InvocResult, error) `perm:"read"`
		StateMinerPartitionsNew func(ctx context.Context, m address.Address, dlIdx uint64, tsk types.TipSetKey) ([]*das.Partition, error) `perm:"read"`
		StateGetParentReceipts func(ctx context.Context, b cid.Cid) ([]*types.MessageReceipt, error) `perm:"read"`
		StateMinerDeadlinesByMiner func(ctx context.Context, m address.Address, tsk types.TipSetKey) ([]*StateMinerDeadlinesByMinerInfo, error) `perm:"read"`
		WalletBalanceByTs func(ctx context.Context, a address.Address, tsk types.TipSetKey) (types.BigInt, error) `perm:"read"`
		StateCallExt func(ctx context.Context, msg *types.Message, priorMsgs types.ChainMsg,tsk types.TipSetKey) (*InvocResult, error) `perm:"read"`
		StateReplayTest func(ctx context.Context, tsk types.TipSetKey, cids []cid.Cid) ([]*InvocResult, error) `perm:"read"`
		StateReplayEx func(ctx context.Context, tsk types.TipSetKey) ([]*InvocResults, error) `perm:"read"`
		StateComputeBaseFee func(ctx context.Context, b cid.Cid) (abi.TokenAmount, error) `perm:"read"`
		StateGetMessageByHeightInterval func(ctx context.Context, start int64) ([]*NMessage, error) `perm:"read"`
		StateGetBlockByHeightInterval func(ctx context.Context, start int64) ([]*types.BlockHeaders, error) `perm:"read"`
		StateGetBlockByHeightWhere func(ctx context.Context, params StateGetBlockByHeightIntervalParams) ([]*types.BlockHeaders, error) `perm:"read"`

		StateGetBlockByHeight func(ctx context.Context, start int64, end int64) ([]*Blocks, error) `perm:"read"`
		StateMinerVestingFundsByHeight func(ctx context.Context, maddr address.Address, start abi.ChainEpoch,end abi.ChainEpoch,tsk types.TipSetKey) ([]map[string]interface{}, error) `perm:"read"`
		StateMessageByHeight func(ctx context.Context,  epoch abi.ChainEpoch) ([]*InvocResultExt, error) `perm:"read"`
		ClientIpfsAddGo func(ctx context.Context,clientIpfsAddParams  ClientIpfsAddGoParams) (ClientIpfsAddGoParams, error) `perm:"read"`
		StateGetMessageByHeightIntervalEx func(ctx context.Context, params StateGetMessageByHeightIntervalParams) ([]*SMessage, error) `perm:"read"`
		StateComputeBaseFeeTest func(ctx context.Context) (abi.TokenAmount, error) `perm:"read"`
		StateReplayNoTs func(p0 context.Context, p2 cid.Cid) (*InvocResult, error) `perm:"read"`
		StateMarketStorageDealNoTs func(p0 context.Context, p1 abi.DealID) (*MarketDeal, error) `perm:"read"`
		StateGetMessageDealsByHeightInterval func(context.Context, int64) ([]*StateGetParentDealsResp, error) `perm:"read"`

		StateTest func(context.Context,StateTestParams) (abi.SectorQuality, error) `perm:"read"`

		StateSectorGetInfoQa func(context.Context, address.Address, abi.SectorNumber, types.TipSetKey) (*StateSectorGetInfoQaResp, error) `perm:"read"`

		StateMinerSectorsQa func(p0 context.Context, p1 address.Address, p2 *bitfield.BitField, p3 types.TipSetKey) ([]*SectorOnChainInfoQa, error) `perm:"read"`


		StateWithdrawal                    func(ctx context.Context, params *StateWithDrawalReq) (string, error)                                            `perm:"read"`
		StateGetMessage                    func(ctx context.Context, params cid.Cid) (*NMessage, error)                                                      `perm:"read"`
		StateMpoolReplace                  func(ctx context.Context, params cid.Cid) (string, error)                                                          `perm:"read"`
		...
		StateDecodeReturn func(p0 context.Context, p1 address.Address, p2 abi.MethodNum, p3 []byte) (string, error) `perm:"read"`
